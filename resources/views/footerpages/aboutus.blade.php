...
<div style="background: linear-gradient(to right top, #051937, #004d7a, #008793, #00bf72, #a8eb12); color: white" class="jumbotron">
    <div class="container text-center">
        <h1>Über uns</h1>
        <p>
            <a class="btn btn-success btn-lg" href="/" role="button">Startseite</a>
        </p>
    </div>
</div>
...
<p>
   ...
   eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Lorem ipsum
