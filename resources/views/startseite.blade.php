...
@section('content')
    ...
    <div class="section section-kitty-description">
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-6">
                    <img src="/img/linkshare.jpg" width="50%" style="border-radius: 50%">
                </div>
                <div class="col-xs-6">
                    <h2>Das Wzw mit den anderen teilen</h2>
                    <p class="lead">
                        Bob verschickt einen Link für das Wzw an Alice und Eve. Diese können nun ebenfalls ihre Ausgaben eintragen.
                    </p>
                </div>
            </div>
            <hr>
